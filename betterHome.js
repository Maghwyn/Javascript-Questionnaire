...
const c1_TEXT_1 = document.createTextNode("Vous avez 2 minutes pour repondre au maximum de question.");
...
const c2_TEXT_3 = document.createTextNode("- Au bout de 5 mauvaises réponses le jeu s'arrète.");
